...
from glaider_fuzz.chat_clients import ClientBase, ClientLangChain, MessageList, BaseMessage, SystemMessage, HumanMessage, AIMessage
from glaider_fuzz.langchain_integration import ChatModelParams, ChatModelInfo
...
@patch('glaider_fuzz.chat_clients.chat_models_info', fake_chat_models_info)
