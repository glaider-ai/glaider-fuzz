[# Contributing to Glaider Fuzzer

Thank you for your interest in contributing to Glaider Fuzzer! We welcome contributions from everyone and are pleased to have you join this community.
...
2. **Clone Your Fork**:
```bash
git clone https://github.com/glaider-ai/glaider-fuzz.git
cd glaider-fuzz
```
...
The easist way to contribute to glaider-fuzz project is by creating a new test!
...
#### That’s all it takes to contribute a new test to the Glaider Fuzzer project!
