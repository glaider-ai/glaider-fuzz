...
def fuzz_prompt_injections(client_config: ClientConfig, attack_config: AttackConfig, threads_count: int, custom_tests: List = None):
    ...
    print(f"To learn about the various attack types, please consult the help section and the Glaider Fuzzer GitHub README.")
    print(f"You can also get a list of all available attack types by running the command '{BRIGHT}glaider-fuzzer --list-attacks{RESET}'.")
