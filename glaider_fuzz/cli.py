...
APP_CONFIG_FILE = os.path.join(os.path.expanduser("~"), ".glaider-fuzzer-config.json")
...
def main():
    ...
    print(f"{BRIGHT}{colorama.Fore.CYAN}Thank you for trying out the Glaider Fuzzer!{RESET}")
